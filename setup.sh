...
echo -n "→ scripts ... "
cp -f ./files/scripts/alldone "$DEST"
cp -f ./files/scripts/cheat "$DEST"
cp -f ./files/scripts/cleardns "$DEST"
cp -f ./files/scripts/git-logdate "$DEST"
cp -f ./files/scripts/git-recent "$DEST"
cp -f ./files/scripts/mcd "$DEST"
cp -f ./files/scripts/pathadd "$DEST"
cp -f ./files/scripts/tailtalk "$DEST"
cp ./files/scripts/prompt-right-side "$DEST"
echo -e "\e[32mok\e[0m"
